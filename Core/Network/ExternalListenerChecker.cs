...
/// </summary>
public sealed class ExternalListenerChecker : OpSecCheckerBase
{
    public override string Name => "Extern gebundene TCP-Dienste";
    public override string Category => "Netzwerk / Angriffsfläche";
